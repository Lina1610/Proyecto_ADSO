    ...
    if request.method == 'POST':
        try:
            ...
            data_form_dict = {
                ...
                'marca': data_form.get('marca', None),  # Opcional
                'unidad_medida': data_form.get('unidad_medida', None)  # Opcional
            }
            ...
            if isinstance(resultado, int) and resultado > 0:
                ...
                return redirect(url_for('lista_productos'))  # Nombre correcto del endpoint
            else:
                flash(f'Error al registrar producto: {resultado}', 'error')
        except Exception as e:
            flash(f'Error inesperado al procesar el formulario: {str(e)}', 'error')
