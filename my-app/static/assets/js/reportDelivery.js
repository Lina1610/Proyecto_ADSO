    ...
    if ($btnExportarPDF) {
        $btnExportarPDF.addEventListener("click", function () {
            try {
                ...
                const title = "Reporte de Entregas" + (hayFiltrosActivos ? " (Filtrado)" : "");
                ...
                const headers = Array.from(document.querySelectorAll("#tbl_entregas thead th"))
                    .filter((th, index) => index < 5) // Excluir columna de acción (índice 5+)
                ...
                const filasAExportar = hayFiltrosActivos 
                    ? filasFiltradas 
                    : document.querySelectorAll("#tbl_entregas tbody tr.fila-datos");
                
                filasAExportar.forEach(tr => {
                    const rowData = Array.from(tr.querySelectorAll("td"))
                        .filter((td, index) => index < 5) // Excluir columna de acción
                ...
                // Generar tabla centrada (más estrecha para 5 columnas)
                doc.autoTable({
                    head: [headers],
                    body: data,
                    ...
                    theme: "grid",
                    styles: { 
                        fontSize: 9, // Un punto más grande para mejor legibilidad
                        cellPadding: 3,
                        overflow: 'linebreak',
                        halign: 'center'
                    },
                    columnStyles: {
                        // Ajustar anchos de columnas específicas para 5 columnas
                        0: { cellWidth: 'auto' },
                        1: { cellWidth: 'auto' },
                        2: { cellWidth: 'auto' },
                        3: { cellWidth: 'auto' },
                    ...
                    tableWidth: 'wrap', // Ajustar automáticamente al contenido
                ...
                doc.save("Reporte_Entregas_TamalesBuenSazon" + (hayFiltrosActivos ? "_Filtrado" : "") + ".pdf");
        ...
        $btnImprimir.addEventListener("click", function () {
            try {
                ...
                ventanaImpresion.document.write(`
                    ...
                    <html>
                    <head>
                        <title>Reporte de Entregas - Tamales el Buen Sazón</title>
                        <style>
                            @media print {
                                body {
                    ...
                    <body>
                        <div class="header">
                            ...
                            <div class="company-info">
                                ...
                                <div class="report-title">Reporte de Entregas${hayFiltrosActivos ? " (Filtrado)" : ""}</div>
