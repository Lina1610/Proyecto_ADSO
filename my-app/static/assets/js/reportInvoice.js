    ...
    if ($btnExportarPDF) {
        $btnExportarPDF.addEventListener("click", function () {
            try {
                ...
                const title = "Reporte de Facturas" + (hayFiltrosActivos ? " (Filtrado)" : "");
                ...
                const headers = Array.from(document.querySelectorAll("#tbl_facturas thead th"))
                    .filter((th, index) => index < 4) // Excluir columna de acción (índice 4+)
                ...
                const filasAExportar = hayFiltrosActivos 
                    ? filasFiltradas 
                    : document.querySelectorAll("#tbl_facturas tbody tr.fila-datos");
                
                filasAExportar.forEach(tr => {
                    const rowData = Array.from(tr.querySelectorAll("td"))
                        .filter((td, index) => index < 4) // Excluir columna de acción
                ...
                // Generar tabla centrada (optimizada para 4 columnas)
                doc.autoTable({
                    head: [headers],
                    body: data,
                    ...
                    columnStyles: {
                        // Ajustar anchos específicos para 4 columnas
                        0: { cellWidth: 'auto' },
                        1: { cellWidth: 'auto' },
                        2: { cellWidth: 'auto' },
                        3: { cellWidth: 'auto' }
                ...
                doc.save("Reporte_Facturas_TamalesBuenSazon" + (hayFiltrosActivos ? "_Filtrado" : "") + ".pdf");
        ...
        $btnImprimir.addEventListener("click", function () {
            try {
                ...
                ventanaImpresion.document.write(`
                    ...
                    <html>
                    <head>
                        <title>Reporte de Facturas - Tamales el Buen Sazón</title>
                        <style>
                            @media print {
                                body {
                    ...
                    <body>
                        <div class="header">
                            ...
                            <div class="company-info">
                                ...
                                <div class="report-title">Reporte de Facturas${hayFiltrosActivos ? " (Filtrado)" : ""}</div>
