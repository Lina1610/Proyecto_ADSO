document.addEventListener("DOMContentLoaded", function () {
    ...
    function mostrarMensaje(mensaje) {
        ...
        alertElement.className = `alert alert-info alert-dismissible fade show`; // Siempre azul
    ...
    if ($btnExportarExcel) {
        $btnExportarExcel.addEventListener("click", function () {
            try {
                ...
                // Comentado: mostrarMensaje("Archivo Excel generado correctamente");
            } catch (error) {
                console.error("Error al exportar a Excel:", error);
                // Comentado: mostrarMensaje("Error al exportar a Excel");
            }
        });
    }
    ...
    if ($btnExportarPDF) {
        $btnExportarPDF.addEventListener("click", function () {
            try {
                ...
                // Comentado: mostrarMensaje("Archivo PDF generado correctamente");
            } catch (error) {
                console.error("Error al exportar a PDF:", error);
                // Comentado: mostrarMensaje("Error al exportar a PDF");
            }
        });
    }
    ...
    if ($btnImprimir) {
        $btnImprimir.addEventListener("click", function () {
            try {
                ...
                // Comentado: mostrarMensaje("Documento enviado a impresión");
            } catch (error) {
                console.error("Error al imprimir:", error);
                // Comentado: mostrarMensaje("Error al imprimir");
            }
        });
    }

    // Llamar a la función para actualizar el mensaje de registros al cargar la página
    actualizarFilasMostradas();
});