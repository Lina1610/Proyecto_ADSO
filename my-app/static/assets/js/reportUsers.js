    ...
    if ($btnExportarExcel) {
        $btnExportarExcel.addEventListener("click", function () {
            try {
                ...
                // Comentado: mostrarMensaje("Archivo Excel generado correctamente", "success");
            } catch (error) {
                console.error("Error al exportar a Excel:", error);
                // Comentado: mostrarMensaje("Error al exportar a Excel", "danger");
            }
        });
    }
    ...
    if ($btnExportarPDF) {
        $btnExportarPDF.addEventListener("click", function () {
            try {
                ...
                // Comentado: mostrarMensaje("Archivo PDF generado correctamente", "success");
            } catch (error) {
                console.error("Error al exportar a PDF:", error);
                // Comentado: mostrarMensaje("Error al exportar a PDF", "danger");
            }
        });
    }
    ...
    if ($btnImprimir) {
        $btnImprimir.addEventListener("click", function () {
            try {
                ...
                // Comentado: mostrarMensaje("Documento enviado a impresión", "info");
            } catch (error) {
                console.error("Error al imprimir:", error);
                // Comentado: mostrarMensaje("Error al imprimir", "danger");
            }
        });
    }
});